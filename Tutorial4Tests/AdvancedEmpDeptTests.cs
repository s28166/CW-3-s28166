...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        // var withMgr = from e in emps where e.Mgr is not null select e;
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps.Join(emps, e => e.Mgr, e => e.EmpNo, (e1, e2) => new { Employee = e1.EName, Manager = e2.EName });
        // var result = from e in emps join e2 in emps on e.Mgr equals e2.EmpNo select new { Employee = e.EName, Manager = e2.EName };
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        // var result = from e in emps select new { e.EName, Total = e.Sal + (e.Comm ?? 0) };
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts, e => e.DeptNo, d => d.DeptNo, (e, d) => new {e, d })
            .SelectMany(g => grades.Where(s => g.e.Sal >= s.Losal && g.e.Sal <= s.Hisal),
                (g, s) => new { g.e.EName, g.d.DName, Grade = s.Grade });
